...
<body>
    <div class="container" style="background-image:url(oi.avif);background-repeat:repeat;">
        <br>
        <br>
        ...
        <center><a href="index.php" style="background-color:black; color:white;">Go Back</a></center><br>
